...
namespace Arrays
{
    public class ContainsDuplicateI
    {
        ...
        public bool ContainsDuplicate(int[] nums)
        {
            ...
            {
                if (dupes.Contains(t)) return true;
                dupes.Add(t);
            }
    ...
    public class ContainsDuplicateII
    {
        ...
        Output: false
            ...
            The way this problem is worded in crap - it has more downvotes than up.
            Based on the LC solution, you just want to maintain a set of size k???
