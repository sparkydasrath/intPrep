...
namespace InterviewTests.centerbridge
{
    public class BishopStrategyGeneration : NumberGenerationStrategy
    {
        ...
        public BishopStrategyGeneration(char[,] baseList, HashSet<char> exclusionSet, HashSet<char> nonStartingSet, bool[,] visited, NumberLength numLength, HashSet<string> results) :
