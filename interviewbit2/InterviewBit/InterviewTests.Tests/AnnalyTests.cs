...
namespace InterviewTests.Tests
{
    ...
    {
        [TestCase(new float[] { 1.50f, 1.50f, 1.50f, 1.50f, 1.50f }, ExpectedResult = 3)]
        ...
        [TestCase(new int[] { 7, 2, 3, 10, 2, 4, 8, 1 }, ExpectedResult = 8)]
        [TestCase(new int[] { 5, 10, 8, 7, 6, 5 }, ExpectedResult = 5)]
        [TestCase(new int[] { 6, 7, 9, 5, 6, 3, 2 }, ExpectedResult = 2)]
        ...
        [TestCase(new int[] { 3, 1, 2, 3 }, new int[] { 3, 2, 1, 3 }, "Even", ExpectedResult = "Andrea")]
